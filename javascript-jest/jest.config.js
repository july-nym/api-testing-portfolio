 ...
 * occasionally cold-start (restful-booker runs on a free Heroku dyno). It must
 * sit above the axios client timeout (30s) so the HTTP layer fails first with a
 * useful message rather than Jest killing the test.
 */
module.exports = {
