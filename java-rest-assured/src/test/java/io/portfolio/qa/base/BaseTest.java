 ...
 * sharing is safe and saves rebuilding the reqres header set on each call. The
 * booker auth token is fetched lazily and cached because not every suite needs
 * it (read-only and reqres tests don't), and booker's token is valid for the run.
 */
public abstract class BaseTest {

    protected RequestSpecification reqres;
